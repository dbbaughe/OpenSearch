...
public class ScheduledJobInfo {
    ...
    /**
     * Gets the map of jobId to {@link JobSchedulingInfo} for the given config index.
     * @param indexName The config index to get jobs for.
     * @return A map of jobId to {@link JobSchedulingInfo}.
     */
    ...
    /**
     * Gets the {@link JobSchedulingInfo} for a given jobId in the given config index.
     * @param indexName The config index to get jobs for.
     * @param jobId The id of the job.
     * @return The {@link JobSchedulingInfo}.
     */
